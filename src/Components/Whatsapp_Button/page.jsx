...
import whatsapp_logo from "@/svgs/whatsappSvg.svg";
...
const WhatsAppButton = () => {
  ...
  const handleScroll = () => {
    ...
    // Assuming that each section is of a certain height, e.g., 800px, adjust this value as needed
    if (scrollPosition > 800) {  // After 2 sections (assuming 800px each)
      setShowButton(true);
    } else {
      setShowButton(false);
    }
